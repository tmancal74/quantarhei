...
from quantarhei.core.units import conversion_facs_energy, eps0_int
...
class TestUnits(unittest.TestCase):
    ...
    def test_energy_units_conversions(self):
        ...
        if self.verbose:
            print(f"J to eV conversion factor: {J2eV} - {self.J2eV} ")
        ...
        if self.verbose:
            print(f"J to THz conversion factor: {J2int / THz2int} - {self.J2THz}")
        ...
        if self.verbose:
            print(f"cm to eV conversion factor: {eV2int / cm2int} - {self.eV2cm} ")
        ...
        if self.verbose:
            print(f"THz to cm conversion factor: {THz2cm} - {self.THz2cm} ")
