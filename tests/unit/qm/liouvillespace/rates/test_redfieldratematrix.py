...
from quantarhei import REAL, CorrelationFunction, Hamiltonian, TimeAxis, energy_units
from quantarhei.qm import Operator, RedfieldRateMatrix, SystemBathInteraction
...
class TestRedfieldRateMatrix(unittest.TestCase):
    ...
    def test_create_of_RedfieldRateMatrix(self):
        ...
        self.assertTrue(
            "First argument must be a Hamiltonian" in str(context.exception)
        )
        ...
        self.assertTrue(
            "Second argument must be a SystemBathInteraction" in str(context.exception)
        )
        ...
        self.assertTrue(
            "No system bath intraction components present" in str(context.exception)
        )
