...
class AggregateTest(unittest.TestCase):
    ...
    def test_saving_of_aggregate(self):
        ...
        self.assertEqual(
            self.agg._has_system_bath_interaction, agg._has_system_bath_interaction
        )
        self.assertEqual(self.agg.coupling_initiated, agg.coupling_initiated)
        self.assertEqual(self.agg._has_relaxation_tensor, agg._has_relaxation_tensor)
        ...
        numpy.testing.assert_array_equal(
            self.agg.resonance_coupling, agg.resonance_coupling
        )
    ...
    def test_trace_over_vibrations(self):
        ...
        numpy.testing.assert_almost_equal(numpy.trace(redr._data), 1.0, decimal=7)
        ...
        numpy.testing.assert_almost_equal(numpy.trace(redr._data), 1.0, decimal=3)
        ...
        numpy.testing.assert_almost_equal(numpy.trace(redr._data), 1.0, decimal=2)
    ...
    def test_get_Density_Matrix_thermal(self):
        ...
        # room temperature
        rho0 = vagg.get_DensityMatrix(condition_type="thermal", temperature=300)
    ...
    def test_set_resonance_coupling(self):
        ...
        self.assertAlmostEqual(
            qr.convert(100.0, "1/cm", "int"), agg.resonance_coupling[0, 1]
        )
        self.assertAlmostEqual(
            qr.convert(100.0, "1/cm", "int"), agg.resonance_coupling[1, 0]
        )
    ...
    def test_projection_operator_generation(self):
        ...
        sbi = qr.qm.SystemBathInteraction(osites=[0, 1], orates=orates, system=agg)
        #
