...
class TestMoleculeVibrations(unittest.TestCase):
    ...
    def test_thermal_density_matrix_finite_temp(self):
        ...
        params = {"ftype": "OverdampedBrownian", "T": 300, "reorg": 30, "cortime": 100}
        with energy_units("1/cm"):
...
class TestMoleculeMultiVibrations(unittest.TestCase):
    def setUp(self):
        ...
        cfce_params1 = dict(
            ftype="OverdampedBrownian", reorg=30.0, cortime=50.0, T=300, matsubara=100
        )
    ...
    def test_potentials(self):
        """(Molecule) Testing multimode Molecule"""
        exp1 = numpy.array([0.45207638, 2.92411307, 3.59543216], dtype=REAL)
        exp2 = numpy.array([0.45207638, 2.9598406, 3.55970463], dtype=REAL)
    ...
    def test_mode_environment(self):
        ...
        self.assertTrue("Correlation function not specified." in str(context.exception))
    ...
    def test_mode_relaxation_one_no_coupling(self):
        ...
        for key in expected.keys():
            ...
            self.assertAlmostEqual(
                expected[key], 1.0 / numpy.real(RT.data[ii, ii, jj, jj])
            )
    ...
    def test_mode_relaxation_two_with_coupling_and_transition_env(self):
        ...
        with eigenbasis_of(ham):
            ...
            for key in expected.keys():
                ...
                jj = key[1]
                self.assertAlmostEqual(
                    expected[key], 1.0 / numpy.real(RT.data[ii, ii, jj, jj]), places=4
                )
