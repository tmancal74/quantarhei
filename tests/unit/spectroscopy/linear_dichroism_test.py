...
# import h5py
from quantarhei.spectroscopy.linear_dichroism import (
    LinDichSpectrumBase,
...
class TestLinDich(unittest.TestCase):
    ...
    def setUp(self, verbose=False):
        ...
        with energy_units("1/cm"):
            ...
            lindich_calc = LinDichSpectrumCalculator(
                time, system=agg, vector_perp_to_membrane=numpy.array((0, 1, 0))
            )
    ...
    def test_LinDichSpectrumBase(self):
        ...
        lindichs2.set_by_interpolation(self.lindichs.axis.data, self.lindichs.data)
        numpy.testing.assert_allclose(
            lindichs2.axis.data, self.lindichs.axis.data, 1e-03
        )
