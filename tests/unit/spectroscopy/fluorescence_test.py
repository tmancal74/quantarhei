...
from quantarhei.spectroscopy.fluorescence import (
    FluorSpectrumBase,
...
class TestFluor(unittest.TestCase):
    ...
    def test_FluorSpectrumBase(self):
        ...
        fluors2.set_by_interpolation(self.fluors.axis.data, self.fluors.data)
        numpy.testing.assert_allclose(fluors2.axis.data, self.fluors.axis.data, 1e-03)
    ...
    def test_fluor_calculator(self):
        ...
        try:
            ...
            fluor_calc = FluorSpectrumCalculator(
                self.ta,
                system=agg,
                dynamics="secular",
