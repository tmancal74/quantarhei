...
class TestAbs(unittest.TestCase):
    ...
    def test_AbsSpectrumBase(self):
        ...
        abss2.set_by_interpolation(self.abss.axis.data, self.abss.data)
        numpy.testing.assert_allclose(abss2.axis.data, self.abss.axis.data, 1e-03)
    ...
    def test_abs_calculator(self):
        ...
        try:
            ...
            abs_calc = AbsSpectrumCalculator(
                self.ta,
                system=agg,
                dynamics="secular",
