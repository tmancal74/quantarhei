...
Feature: EvolutionSuperOperator can be calculated with pure dephasing
    ...
    Scenario Outline: EvolutionSuperOperator can be calculated with Lindbladform and Gaussian and Lorenzian pure dephasing step by step
...
#        |  50.0   |    10.0     |    10     |   200.0  |
    ...
    Scenario Outline: EvolutionSuperOperator can be calculated with Gaussian and Lorenzian pure dephasing in one shot
        Given I have PureDephasing object D with dephasing constant <dtime> and initial density matrix R
    ...
    Scenario Outline: EvolutionSuperOperator can be calculated with Lindbladform and Gaussian and Lorenzian pure dephasing in one shot
        Given I have a Hamiltonian H, Lidblad form L, PureDephasing object D with dephasing constant <dtime> and initial density matrix R
