...
Feature: Calculation of Redfield relaxation tensor in a homodimer

    As a user I want to calculate relaxation tensor in a homodimer by Redfield theory
...
Scenario Outline: Refield tensor for a homodimer against analytical result with step dt = 1.0
    ...
    Then I get Redfield relaxation rates corresponding to analytical results for a homodimer with rtol 0.03
