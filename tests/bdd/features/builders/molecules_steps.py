...
@step(r'I create a transition dipole moment vector')
def i_create_transition_dipole(self,dx,dy,dz,units):
    world.tdm = [float(dx),float(dy),float(dz)]
    world.tdm_units = units
