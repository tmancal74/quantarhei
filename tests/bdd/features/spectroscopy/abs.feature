...
Scenario Outline: A user calculates absorption spectrum of an aggregate of three two-level molecule
    ...
    Examples:
        | ctype              | reorg | e_units | ctime | t_units | temp   | T_units | mats | file                         |
        | OverdampedBrownian | 20.0  | 1/cm    | 100   |   fs    | 300    | K       | 20   | abs_3mol_20cm_100fs_300K_m20.dat |
        | OverdampedBrownian | 20.0  | 1/cm    | 100   |   fs    | 100    | K       | 20   | abs_3mol_20cm_100fs_100K_m20.dat |
