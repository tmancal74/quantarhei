...
"""
cfce_params1 = dict(
    ftype="OverdampedBrownian", reorg=20.0, cortime=100.0, T=100, matsubara=20
)
...
cfce_params1 = dict(
    ftype="OverdampedBrownian", reorg=10.0, cortime=60.0, T=100, matsubara=20
)
cfce_params2 = dict(
    ftype="OverdampedBrownian", reorg=10.0, cortime=60.0, T=100, matsubara=20
)
...
cfce_params1 = dict(
    ftype="OverdampedBrownian", reorg=20.0, cortime=60.0, T=100, matsubara=20
)
cfce_params2 = dict(
    ftype="OverdampedBrownian", reorg=20.0, cortime=60.0, T=100, matsubara=20
)
...
(RRf, hamf) = AG.get_RelaxationTensor(
    ta, relaxation_theory="standard_Foerster", time_dependent=True
)
(RRr, hamr) = AG.get_RelaxationTensor(
    ta, relaxation_theory="standard_Redfield", time_dependent=True
)
...
ac1 = qr.AbsSpectrumCalculator(
    ta, AG, relaxation_tensor=RRf, effective_hamiltonian=hamf
)

ac2 = qr.AbsSpectrumCalculator(
    ta, AG, relaxation_tensor=RRr, effective_hamiltonian=hamr
)
