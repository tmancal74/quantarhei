...
cpar1 = dict(ftype="OverdampedBrownian-HighTemperature", reorg=50, cortime=50, T=300)
...
ip8 = IntegrodiffPropagator(
    timea, ham, kernel=ker, fft=True, timefac=3, decay_fraction=2.0
)
