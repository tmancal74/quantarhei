...
pways = dict()
resp_plus = calc.calculate_one_system(
    t2.data[0], agg, eUt, lab, pways=pways, selection=sel_1, dtol=0.0001
)

resp_mins = calc.calculate_one_system(
    t2.data[0], agg, eUt, lab, pways=pways, selection=sel_2, dtol=0.0001
)
