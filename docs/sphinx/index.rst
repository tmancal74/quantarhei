...
of learning to use Quantarhei. Not only that one can learn to use Quantarhei
better by inspecting the source code. In a better case you learn something
usefull from how open quantum systems' problems are solved in Quantarhei,
in a worse case, you will be motivated to fix Quantarhei's deficiencies. 

There two types of deficiencies you can expect in Quantarhei - a mild one:
...
Here we provide a detailed description of the classes provided by Quantarhei.
